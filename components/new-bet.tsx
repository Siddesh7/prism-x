      ...
      <div className="space-y-4">
        ...
        {step === 0 && (
          <Textarea
            ...
            className="w-full h-24 bg-gray-900 text-white border-primary focus:border-primary resize-none"
          />
        )}
        {step === 1 && (
          <>
            <div className="space-y-2">
              ...
              <Input
                ...
                min="1"
                max="2160"
                className="bg-gray-900 text-white border-primary focus:border-primary"
              />
            </div>
            <div className="space-y-2">
                ...
                {steps.map((s, index) => (
                  <div
                    ...
                    className={`flex flex-col items-center ${
                      index === step ? "text-primary" : "text-gray-500"
                    }`}
                  >
                    <div
                      className={`w-8 h-8 rounded-full flex items-center justify-center ${
                        index === step ? "bg-primary text-black" : "bg-gray-800"
                      }`}
                    >
                      {index < step ? "✓" : s.icon}
                    </div>
              ...
              <div className="flex flex-col mt-auto pt-8 pb-4">
                <div className="flex justify-between">
                  <Button
                    ...
                    disabled={step === 0}
                    className="bg-primary hover:bg-primary disabled:bg-gray-800 disabled:hover:bg-gray-800 transition-all duration-300 shadow-[0_0_15px_rgba(220,38,38,0.5)] disabled:shadow-none"
                  >
                    ◀ Back
                  </Button>
                  {step < steps.length - 1 ? (
                    <Button
                      ...
                      className="bg-primary hover:bg-primary transition-all duration-300 shadow-[0_0_15px_rgba(220,38,38,0.5)]"
                    >
                      Next ▶
                    </Button>
                  ) : (
